    ...
    <div style="background: #e6eaf2">
        <div class="row">
          ...
          <span class="glyphicon glyphicon-edit"></span>
           ...
           <label style="font-size: 14px"> Edit profile </label><br>
          <a href="#">
          <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <span class="glyphicon glyphicon-edit"></span>
        </a>
           ...
           <div class="container" style="background: white; margin-top: 11px;width:100%">
             <!-- <div class="container" style="background: white; margin-top: 11px;width: 100%;height: 189px;"> -->
               ...
               <label style="color:#c2d6d6;">friend requests</label>
               </div>
               </div>
               <hr>
               <form:form name="search" method="POST" action="/spring_1/approve_rqst" modelAttribute="Searchbean" id="for"> 
               ...
               <div class="col-md-4">
                ...
                <a href="/spring_1/confirm?id=<c:out value="${user.pk_int_user_id}"/>" style="color:grey;"><span class="glyphicon glyphicon-user" style="color:grey;" ></span>
<i class="glyphicon glyphicon-plus" style="color:grey;"></i>confirm</a>
</div>
            <div class=" col-md-3">

 <a href="/spring_1/delete?id=<c:out value="${user.pk_int_user_id}"/>" style="color:grey;"><span class="glyphicon glyphicon-user" style="color:grey;" ></span>
  delete</a>
