     ...
     <div class="row"> <label style="color: black; text-align: left;margin-top:100px"><b> facebook login</label></div><hr style="color: #b0b1b2">
      ...
      <div class="col-md-3">
         ...
         <div class="col-md-3">
          ...
          title="The email you've enterd doesnt match with any account .sign up for a account" style="margin-left: -56px" id="maill" name="ema">
          
            </div>
           
<div class="col-md-3">
           <label><b>${fname} ${lname}</b></label>
           </div>
     </div>
     <div class="row">
           <div class="col-md-2">
    ...
    width: 100%;position: absolute;margin-left: 316px">
     EMAIL you've enterd is wrong.forgotten EMAIL?
           </div>          </div>
          <div class="row">
